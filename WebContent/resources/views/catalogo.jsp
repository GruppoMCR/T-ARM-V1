	...
	<div layout="row" layout-wrap>
		...
		<div class="listAnimals" layout="column"
			...
			<md-card> <img ng-src="{{imagePath}}" class="md-card-image"
				alt="user avatar"> <md-card-content>
			...
			<div class="dialogBoxIcons" layout="row"
				...
				<!-- 				</div> --> </md-button>
				<!-- 			<md-divider></md-divider> -->
				<md-button> <!-- 				<div> --> <md-icon
					class="material-icons md-light md-8" flex="10"> forward</md-icon> <!-- 					<p class="textDogCards">Condividi</p> -->
				<!-- 				</div> --> </md-button>
			...
			</md-card-content> <!-- 			<div class="animalCardsAdoption" layout="row" layout-wrap> -->
